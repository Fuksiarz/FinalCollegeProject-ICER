...
import threading
import json
from flask import Flask, request, render_template, send_file, redirect, url_for, send_from_directory, make_response, flash, jsonify, Response
...
# 5 routes for video food identification
